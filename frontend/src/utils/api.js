...
export function fetchAlertProofs(alertId) {
  return request(`/api/alerts/${alertId}/proofs`);
}

export function updateAlertProofStatus(alertId, proofId, status) {
  return request(`/api/alerts/${alertId}/proofs/${proofId}`, {
    method: "PUT",
    headers: { "Content-Type": "application/json" },
